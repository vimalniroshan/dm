...
public class EntityManagerImpl<T> implements EntityManager<T> {
    ...
    public Map<Field, String> fkFieldsWithTargetQuery = new HashMap<Field, String>();
    ...
    public EntityManagerImpl(final Class<T> entity) {
        ...
        for(Field f : entity.getDeclaredFields()) {
            ...
            if (fk != null) {
                if (StringUtils.isNotBlank(fk.targetQuery())) {
                    fkFieldsWithTargetQuery.put(f, fk.targetQuery());
                }
                fkFields.add(f);
            }
    ...
    public Map<Field, String> getFkFieldsWithTargetQuery() {
        return fkFieldsWithTargetQuery;
    }
